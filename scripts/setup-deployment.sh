...
$DEPLOY_USER ALL=(ALL) NOPASSWD: /usr/bin/killall npm
$DEPLOY_USER ALL=(ALL) NOPASSWD: /usr/bin/killall node
$DEPLOY_USER ALL=(ALL) NOPASSWD: /usr/bin/killall npm ci
$DEPLOY_USER ALL=(ALL) NOPASSWD: /usr/bin/kill -9 *
EOF
